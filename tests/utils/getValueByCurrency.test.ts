...
describe('testing getValueByCurrency function', () => {
    const dataSet = [
        {value: 0, currency: 'HUF', expected: '0'},
        {value: 1, currency: 'HUF', expected: '1'},
        {value: 10, currency: 'HUF', expected: '10'},
        {value: 100000000, currency: 'HUF', expected: '100000000'},
        {value: 123456789, currency: 'HUF', expected: '123456789'},
        {value: -123456789, currency: 'HUF', expected: '-123456789'},
        {value: 0, currency: 'TWD', expected: '0'},
        {value: 1, currency: 'TWD', expected: '1'},
        {value: 10, currency: 'TWD', expected: '10'},
        {value: 100000000, currency: 'TWD', expected: '100000000'},
